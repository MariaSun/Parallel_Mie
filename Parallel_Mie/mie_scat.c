//The code is taken from : https://github.com/xurunb/research/blob/master/Program_Backup/Mie_Scattering/bhmie.c
//Has been modified
...
#include "complex.h"
#include "nrutil.h"
#define mxnang 20000 /* defines max number of angles between 0 and 90 degrees */
...
//    int j,N=50;
//
//    double cxref_r, cxref_i, cxs1_r, cxs1_i, cxs2_r, cxs2_i;
//    unsigned long nang;
//
...
//    for (j=0; j<=N; j++) {
//        bhmie(x, cxref_r, cxref_i, nang, j*Theta, &cxs1_r, &cxs1_i, &cxs2_r, &cxs2_i, &qext, &qsca, &qback, &gsca);
//        printf("%e.10 %e.10 %e.10 %e.10 %e.10 ", j*Theta, cxs1_r, cxs1_i,
//               cxs2_r, cxs2_i);
//    }
//    
//    return 0;
 ...
 */
{
    ...
    fcomplex cxtemp, cxref;
    fcomplex cxs1[mxnang], cxs2[mxnang];
    
    float apsi, apsi0, apsi1, chi, chi0, chi1, fn, p,
    rn, t, theta, xstop, ymod;//pii
    double  dn, dx, psi, psi0, psi1;
    unsigned int  j, jj, n, nmx, nn, nstop;
    /* .. Local Arrays ..*/
    // MF: this is so bad, hard-coded array sizes!
    fcomplex cxd[nmxx];
